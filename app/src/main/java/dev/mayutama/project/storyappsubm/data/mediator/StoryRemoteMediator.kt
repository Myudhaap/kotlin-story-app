package dev.mayutama.project.storyappsubm.data.mediator
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = ApiConfig.getApiStoryService(true).stories(page, state.config.pageSize, location)
            ...
            database.withTransaction {
                ...
                database.storyDao().insertQuote(mappingToEntity(responseData.listStory))
            }
    ...
    private fun mappingToEntity(stories: List<StoryRes.Story>): List<StoryEntity> {
